...
bool Settings_Parse(Settings_Data* settings, char* key, float value)
{
    ...
    if (strcmp(key, "screenWidth") == 0)            { settings->screenWidth = (int)value;        return true; }
    else if (strcmp(key, "screenHeight") == 0)      { settings->screenHeight = (int)value;       return true; }
    else if (strcmp(key, "mouseSensitivity") == 0)  { settings->mouseSensitivity = value;        return true; }
    else if (strcmp(key, "cameraFOV") == 0)         { settings->cameraFOV = (int)value;          return true; }
    else if (strcmp(key, "maxFPS") == 0)            { settings->maxFPS = (int)value;             return true; }
    else if (strcmp(key, "keyMoveForward") == 0)    { settings->keyMoveForward = (int)value;     return true; }
    else if (strcmp(key, "keyMoveBackward") == 0)   { settings->keyMoveBackward = (int)value;    return true; }
    else if (strcmp(key, "keyMoveLeft") == 0)       { settings->keyMoveLeft = (int)value;        return true; }
    else if (strcmp(key, "keyMoveRight") == 0)      { settings->keyMoveRight = (int)value;       return true; }
    else if (strcmp(key, "keyFire") == 0)           { settings->keyFire = (int)value;            return true; }
    else if (strcmp(key, "keyUse") == 0)            { settings->keyUse = (int)value;             return true; }
    else if (strcmp(key, "keyJump") == 0)           { settings->keyJump = (int)value;            return true; }
    else if (strcmp(key, "keyWeaponOne") == 0)      { settings->keyWeaponOne = (int)value;       return true; }
    else if (strcmp(key, "keyWeaponTwo") == 0)      { settings->keyWeaponTwo = (int)value;       return true; }
    else if (strcmp(key, "keyWeaponThree") == 0)    { settings->keyWeaponThree = (int)value;     return true; }
    else if (strcmp(key, "keyWeaponFour") == 0)     { settings->keyWeaponFour = (int)value;      return true; }
    else if (strcmp(key, "keyWeaponFive") == 0)     { settings->keyWeaponFive = (int)value;      return true; }
    else
    {
